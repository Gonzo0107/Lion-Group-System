                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="http://localhost/lion_group_system/ASESOR DE VENTAS/comision/comision.php">Comision</a>
                                    <a class="nav-link" href="http://localhost/lion_group_system/ASESOR DE VENTAS/formulario/formulario.php">formulario</a>
                                    <a class="nav-link" href="http://localhost/lion_group_system/ASESOR DE VENTAS/reclamaciones/reclamaciones.php">reclamaciones</a>
                                </nav>
                            </div>
