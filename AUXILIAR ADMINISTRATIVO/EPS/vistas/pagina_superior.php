...
<html lang="en">
    ...
    <body class="sb-nav-fixed jus">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-light border-bottom border-light shadow ">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3 mb-1 bg-primary p-3" href="http://localhost/lion_group_system/ASESOR DE VENTAS/principal/principal.php">Principal</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="http://localhost/lion_group_system/AUXILIAR ADMINISTRATIVO/comision/comision.php">tipo salud</a>
                                    <a class="nav-link" href="http://localhost/lion_group_system/AUXILIAR ADMINISTRATIVO/comision/comision.php">tipo pension</a>
                                    <a class="nav-link" href="http://localhost/lion_group_system/AUXILIAR ADMINISTRATIVO/comision/comision.php">formulario</a>
                                    <a class="nav-link" href="http://localhost/lion_group_system/AUXILIAR ADMINISTRATIVO/comision/comision.php">estado</a>
                                    <a class="nav-link" href="http://localhost/lion_group_system/AUXILIAR ADMINISTRATIVO/comision/comision.php">reclamaciones</a>
